...
sub ProcessMMD2PDFXeLaTeX {
	...
	my $tex_string = "; xelatex mmd.tex; biber -u -U mmd; makeglossaries mmd; makeindex -t mmd.glg -o mmd.gls -s mmd.ist mmd.glo; xelatex mmd.tex; xelatex mmd.tex xelatex mmd.tex;";
