...
sub ProcessMMD2PDFXeLaTeX {
	...
	my $tex_string = "; xelatex -output-driver=xdvipdfmx mmd.tex; biber -u -U mmd; makeglossaries mmd; xelatex -output-driver=xdvipdfmx mmd.tex; xelatex -output-driver=xdvipdfmx mmd.tex xelatex -output-driver=xdvipdfmx mmd.tex;";
