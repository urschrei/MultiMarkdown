...
sub ProcessMMD2PDF {
	...
	my $tex_string = "; pdflatex mmd.tex ; biber mmd ; makeglossaries mmd ; pdflatex mmd.tex ; pdflatex mmd.tex";
...
sub ProcessMMD2PDFXeLaTeX {
	...
	my $tex_string = "; xelatex mmd.tex ; biber mmd ; makeglossaries mmd ; xelatex mmd.tex ; xelatex mmd.tex ; xelatex mmd.tex";
